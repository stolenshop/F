//My first completed chapter from Three.js Journey https://threejs-journey.com/ by Bruno Simon

//🔗 Live Demo: https://3d-text-threejs-vert.vercel.app/

//📂 Code: https://github.com/vo-design/threejs-basics
...
import { GUI, Controller } from "https://cdn.skypack.dev/lil-gui@0.18.1";
import { Color } from "https://esm.sh/three";
...
const matcapTextures = [
  textureLoader.load(
    "https://3d-text-threejs-vert.vercel.app/static/textures/matcaps/1.png"
  ),
  textureLoader.load(
    "https://3d-text-threejs-vert.vercel.app/static/textures/matcaps/2.png"
  ),
  textureLoader.load(
    "https://3d-text-threejs-vert.vercel.app/static/textures/matcaps/3.png"
  ),
  textureLoader.load(
    "https://3d-text-threejs-vert.vercel.app/static/textures/matcaps/4.png"
  ),
  textureLoader.load(
    "https://3d-text-threejs-vert.vercel.app/static/textures/matcaps/5.png"
  ),
  textureLoader.load(
    "https://3d-text-threejs-vert.vercel.app/static/textures/matcaps/6.png"
  ),
  textureLoader.load(
    "https://3d-text-threejs-vert.vercel.app/static/textures/matcaps/7.png"
  ),
  textureLoader.load(
    "https://3d-text-threejs-vert.vercel.app/static/textures/matcaps/8.png"
  )
];
...
fontLoader.load(
  "https://3d-text-threejs-vert.vercel.app/static/fonts/helvetiker_regular.typeface.json",
  (font) => {
    debugObject.font = font;
    debugObject.textContent = "<Los amo/>";
    ...
    gui
      .add(debugObject, "bevelThickness", 0.005, 0.05, 0.005)
      .onChange(createText);
      ...
      .add(
        {
          changeMatcap: () => {
            matcapTexture =
              matcapTextures[Math.floor(Math.random() * matcapTextures.length)];
